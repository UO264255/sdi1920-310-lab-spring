...
public class NotaneitorTests {
	...
	// PR1. Loguearse con exito desde el ROl de Usuario, 99999990D, 123456 y
	// desconectarse
	@Test
	public void PR11() {
		// Vamos al formulario de logueo.
	...
	// PR13. Loguearse como estudiante y ver los detalles del anotacon Descripcion =
	// NotaA2.
	...
	// P14. Loguearse como profesor y Agregar NotaA2.
	// P14. Esta prueba podría encapsularse mejor...
	@Test
	public void PR14() {
		// Nos logeamos correctamente
		PO_PrivateView.startTest(driver, "99999993D", "99999993D");
	...
	// PR15. Loguearse como profesor, vamos a la ultima página y Eliminamos la Nota
	// Nueva 1.
	...
	public void PR15() {
		...
		// Y Pinchamos en el enlace de borrado de la Nota "NotaNueva1"
		// td[contains(text(), 'NotaNueva1')]/following-sibling::*/a[contains(text(),
		// 'mark/delete')]"
		elementos = PO_View.checkElement(driver, "free",
				"//td[contains(text(), 'Nota Nueva 1')]/following-sibling::*/a[contains(@href, 'mark/delete')]");
		elementos.get(0).click();
		// Volvemosa la última pagina
		elementos = PO_View.checkElement(driver, "free", "//a[contains(@class, 'page-link')]");
		elementos.get(3).click();
		// Y esperamos a que NO aparezca la ultima "NuevaNota1"

...
public class PO_NavView extends PO_View {
	...
	public static void changeIdiom(WebDriver driver, String textLanguage) {
		...
		List<WebElement> elementos= SeleniumUtils.EsperaCargaPagina(driver, "id", "btnLanguage", getTimeout());elementos.get(0).click();//Esperamos a que aparezca el menú de opciones.
